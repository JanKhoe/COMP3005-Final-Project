...
VALUES
  (15, true, 60, 'CPT, Strength Training', 'Passionate about helping people get stronger.'),
   (16, true, 50, 'CPT', 'Former athlete turned professional trainer.'),
   (17, false, 55, NULL, 'Currently on leave.');
   */
