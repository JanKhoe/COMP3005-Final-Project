...
VALUES
  (12, true, 60, 'CPT, Strength Training', 'Passionate about helping people get stronger.'),
   (13, true, 50, 'CPT', 'Former athlete turned professional trainer.'),
   (14, false, 55, NULL, 'Currently on leave.');
